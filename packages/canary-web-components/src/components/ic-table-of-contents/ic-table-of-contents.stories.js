                ...
                <ic-accordion>
                  <ic-accordion-item>
                    ...
                    <ic-accordion-content
                      >Accordion Content</ic-accordion-content
                    >
                  </ic-accordion-item>
                </ic-accordion>
                <h5>subheading5</h5>
      ...
      <div style="display:flex; flex-direction:row; height:100%;">
        ...
        <div style="width:100%;">
          ...
          <ic-table-of-contents position="right" truncate="true" size="large">
            ...
            >
              <div id="red" style="height:100vh; width:1200px; background:gray">
                <h2>Test something</h2>
              </div>
              <div id="blue" style="height:100vh; background:darkgray">
                <h2>another test Truncate text when long heading</h2>
              </div>
            </div>
          </ic-table-of-contents>
        </div>
