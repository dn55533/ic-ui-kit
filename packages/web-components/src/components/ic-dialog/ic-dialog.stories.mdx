...
<Canvas>
  <Story name="Popover" parameters={{ loki: { skip: true } }}>
    {html`
      <script>
        ...
        document
          ...
          .addEventListener("click", () => {
            document.querySelector("#select-dialog").showDialog();
          });
        document
          .querySelector("#search-dialog-btn")
          .addEventListener("click", () => {
            document.querySelector("#search-dialog").showDialog();
          });
        document
          .querySelector("#tooltip-dialog-btn")
          .addEventListener("click", () => {
            document.querySelector("#tooltip-dialog").showDialog();
          });
        ...
        document
          ...
          .addEventListener("click", () => {
            document.querySelector("#popover-menu-dialog").showDialog();
          });
        document
      ...
      <ic-dialog heading="Long Text Select" id="long-text-select-dialog">
        <ic-typography>
          It has survived not only five centuries, but also the leap into
          electronic typesetting, remaining essentially unchanged. It was
          popularised in the 1960s with the release of Letraset sheets
